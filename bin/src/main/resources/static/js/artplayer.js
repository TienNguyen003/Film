...
!function(e, t, r, o, i) {
    ...
    E13ST: [function(e, t, r) {
        ...
        class te extends c.default {
            constructor(e, t) {
                ...
                this.isRotate = !1,
                this.isDestroy = !1,
                this.whitelist = new (0,
                g.default)(this),
                this.template = new (0,
                v.default)(this),
                this.events = new (0,
                C.default)(this),
                this.whitelist.state ? (this.storage = new (0,
                U.default)(this),
                this.icons = new (0,
                _.default)(this),
                this.i18n = new (0,
                ...
                W.default)(this),
                this.plugins = new (0,
                X.default)(this)) : this.mobile = new (0,
                G.default)(this),
        ...
        console.log(`%c ArtPlayer %c ${te.version} %c https://artplayer.org`, "color: #fff; background: #5f5f5f", "color: #fff; background: #4bc729", "")
    }
    , {
        ...
        t.exports = function() {
            ...
            function i(e, t) {
                ...
                function(e, t, o) {
                    ...
                    if ("object" === s) {
                        if ("object" !== l)
                            throw new Error("[Type Error]: '".concat(o.join("."), "' require 'object' type, but got '").concat(l, "'"));
                    ...
                    if ("array" === s) {
                        if ("array" !== l)
                            throw new Error("[Type Error]: '".concat(o.join("."), "' require 'array' type, but got '").concat(l, "'"));
            ...
            function a(e, t, o) {
                if ("string" === r(t)) {
                    var i = r(e);
                    if ("?" === t[0] && (t = t.slice(1) + "|undefined"),
                    !(-1 < t.indexOf("|") ? t.split("|").map((function(e) {
                        ...
                        throw new Error("[Type Error]: '".concat(o.join("."), "' require '").concat(t, "' type, but got '").concat(i, "'"))
                }
            }
            function n(e, t, o) {
                if ("function" === r(t)) {
    ...
    fqaW9: [function(e, t, r) {
        ...
        function p(e, t) {
            return t instanceof Element ? e.appendChild(t) : e.insertAdjacentHTML("beforeend", String(t)),
        ...
        function y(e, t, r="top") {
            i.isMobile || (e.setAttribute("aria-label", t),
            s(e, "hint--rounded"),
            s(e, `hint--${r}`))
        }
        function v(e, t=0) {
    ...
    kNZvP: [function(e, t, r) {
        ...
        class i extends Error {
            constructor(e, t) {
                super(e),
                "function" == typeof Error.captureStackTrace && Error.captureStackTrace(this, t || this.constructor),
    ...
    eZUgm: [function(e, t, r) {
        var o = e("@parcel/transformer-js/src/esmodule-helpers.js");
        function i(e) {
            return "WEBVTT \r\n\r\n".concat((t = e,
            t.replace(/(\d\d:\d\d:\d\d)[,.](\d+)/g, ((e,t,r)=>{
                let o = r.slice(0, 3);
                return 1 === r.length && (o = r + "00"),
                2 === r.length && (o = r + "0"),
                `${t},${o}`
            }
        ...
        function n(e) {
            ...
            return `WEBVTT\n\n${e.split(/\r?\n/).map((e=>{
                ...
                return o ? {
                    ...
                    text: o[5].replace(/{[\s\S]*?}/g, "").replace(/(\\N)/g, "\n").trim().split(/\r?\n/).map((e=>e.trim())).join("\n")
                } : null
            }
    ...
    "3izFE": [function(e, t, r) {
        var o = e("@parcel/transformer-js/src/esmodule-helpers.js");
        o.defineInteropFlag(r),
        o.export(r, "ComponentOption", (()=>d));
        var i = e("../utils");
        const a = "array"
          , n = "boolean"
          , s = "string"
        ...
        function u(e, t, r) {
            return (0,
            i.errorHandle)(t === s || t === l || e instanceof Element, `${r.join(".")} require '${s}' or 'Element' type`)
        }
        const d = {
            html: u,
            disable: `?${n}`,
        ...
        r.default = {
            ...
            controls: [{
                ...
                position: (e,t,r)=>{
                    ...
                    return (0,
                    i.errorHandle)(o.includes(e), `${r.join(".")} only accept ${o.toString()} as parameters`)
                }
            }],
            quality: [{
                default: `?${n}`,
    ...
    "7CkCt": [function(e, t, r) {
        ...
        r.default = class {
            ...
            get state() {
                const {option: e, constructor: {kindOf: t}} = this.art;
                return !o.isMobile || e.whitelist.some((e=>{
                    switch (t(e)) {
                    case "string":
    ...
    "8iGAh": [function(e, t, r) {
        ...
        class i {
            constructor(e) {
                ...
                t.container instanceof Element ? this.$container = t.container : (this.$container = (0,
                o.query)(t.container),
                (0,
                o.errorHandle)(this.$container, `No container element found by ${t.container}`));
                const a = this.$container.tagName.toLowerCase();
                (0,
                o.errorHandle)("div" === a, `Unsupported container element type, only support 'div' but got '${a}'`),
                (0,
                o.errorHandle)(r.instances.every((e=>e.template.$container !== this.$container)), "Cannot mount multiple instances on the same dom element"),
            ...
            desktop() {
                ...
                e.backdrop && ((0,
                o.addClass)(this.$setting, "art-backdrop-filter"),
                (0,
                o.addClass)(this.$contextmenu, "art-backdrop-filter"),
                (0,
                o.addClass)(this.$info, "art-backdrop-filter")),
                o.isMobile && (0,
                o.addClass)(this.$player, "art-mobile")
            }
            mobile() {
                this.$container.innerHTML = '<div class="art-video-player"><video class="art-video"></video></div>',
                this.$player = this.query(".art-video-player"),
                this.$video = this.query(".art-video")
            }
            destroy(e) {
                e ? (0,
                o.replaceElement)(this.$original, this.$container) : (0,
                o.addClass)(this.$player, "art-destroy")
            }
        }
        r.default = i
    }
    ...
    "9mMBB": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, template: {$video: r}} = e;
            (0,
            o.def)(e, "url", {
                get: ()=>r.currentSrc,
                async set(i) {
                    if (i) {
                        ...
                        o.sleep)(),
                        e.loading.show = !0,
                        n.call(e, r, i, e)) : (e.url && e.url !== i && e.once("video:canplay", (()=>{
    ...
    ghisN: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$video: t}} = e;
            (0,
            o.def)(e, "attr", {
                value(e, r) {
                    if (void 0 === r)
    ...
    l5N6R: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {i18n: t, notice: r, option: i, constructor: {instances: a}, template: {$video: n}} = e;
            (0,
            o.def)(e, "play", {
                value: async function() {
                    const o = await n.play();
                    if (r.show = t.get("Play"),
                    e.emit("play"),
                    i.mutex)
    ...
    fVR5i: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$video: t}, i18n: r, notice: i} = e;
            (0,
            o.def)(e, "pause", {
                value() {
                    const o = t.pause();
                    return i.show = r.get("Pause"),
                    e.emit("pause"),
                    o
                }
            })
        ...
        r.default = function(e) {
            ...
            o.def)(e, "seek", {
                set(r) {
                    ...
                    e.duration && (t.show = `${(0,
                    o.secondToTime)(e.currentTime)} / ${(0,
    ...
    ivSmC: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$video: t}, i18n: r, notice: i, storage: a} = e;
            (0,
            o.def)(e, "volume", {
                get: ()=>t.volume || 0,
                set: n=>{
    ...
    "8LbXb": [function(e, t, r) {
        ...
        r.default = function(e) {
            ...
            o.def)(e, "currentTime", {
                ...
                set: r=>{
                    r = parseFloat(r),
                    Number.isNaN(r) || (t.currentTime = (0,
                    o.clamp)(r, 0, e.duration))
                }
            })
        }
    }
    ...
    kNcxE: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$video: t}, i18n: r, notice: i} = e;
            (0,
            o.def)(e, "playbackRate", {
                get: ()=>t.playbackRate,
                set(a) {
                    if (a) {
                        if (a === t.playbackRate)
                            return;
                        const n = [.25, .5, .75, 1, 1.25, 1.5, 1.75, 2, 3, 4];
                        (0,
                        o.errorHandle)(n.includes(a), `'playbackRate' only accept ${n.toString()} as parameters`),
                        t.playbackRate = a,
    ...
    "8v5yt": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$video: t, $player: r}, i18n: i, notice: a} = e;
            (0,
            o.def)(e, "aspectRatio", {
                ...
                set(n) {
                    ...
                    if ((0,
                    o.errorHandle)(s.includes(n), `'aspectRatio' only accept ${s.toString()} as parameters`),
                    "default" === n)
                        (0,
                        o.setStyle)(t, "width", null),
                        (0,
                        o.setStyle)(t, "height", null),
                        (0,
                        o.setStyle)(t, "padding", null),
                        ...
                        if (c > p) {
                            const e = p * a / i;
                            (0,
                            o.setStyle)(t, "width", 100 * e + "%"),
                            (0,
                            o.setStyle)(t, "height", "100%"),
                            (0,
                            o.setStyle)(t, "padding", `0 ${(s - s * e) / 2}px`)
                        } else {
                            const e = i / p / a;
                            (0,
                            o.setStyle)(t, "width", "100%"),
                            (0,
                            o.setStyle)(t, "height", 100 * e + "%"),
                            (0,
                            o.setStyle)(t, "padding", (l - l * e) / 2 + "px 0")
                        }
    ...
    eLUEv: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, notice: r, template: {$video: i}} = e
              , a = (0,
            ...
            o.def)(e, "screenshot", {
                value: async()=>{
                    ...
                    return (0,
                    o.download)(r, `${t.title || "artplayer"}_${(0,
                    o.secondToTime)(i.currentTime)}.png`),
                    e.emit("screenshot", r),
                    r
                }
            })
    ...
    ifvhR: [function(e, t, r) {
        ...
        var i = e("../libs/screenfull")
          ...
          , n = e("../utils");
        r.default = function(e) {
            const {i18n: t, notice: r, template: {$video: o, $player: i}} = e;
                ...
                a.default.isEnabled ? (e=>{
                    ...
                    n.def)(e, "fullscreen", {
                        ...
                        async set(t) {
                            ...
                            (0,
                            n.addClass)(i, "art-fullscreen"),
                            e.emit("resize"),
                            e.emit("fullscreen", !0),
                            r.show = "") : (e.aspectRatioReset = !0,
                            e.autoSize = e.option.autoSize,
                            await a.default.exit(),
                            (0,
                            n.removeClass)(i, "art-fullscreen"),
                            e.emit("resize"),
                            e.emit("fullscreen", !1),
                            r.show = "")
                        }
    ...
    dsFtO: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {notice: t, template: {$player: r}} = e;
            (0,
            o.def)(e, "fullscreenWeb", {
                get: ()=>(0,
                o.hasClass)(r, "art-fullscreen-web"),
                set(i) {
                    i ? (e.normalSize = "fullscreenWeb",
                    (0,
                    o.addClass)(r, "art-fullscreen-web"),
                    e.aspectRatioReset = !0,
                    e.autoSize = !1,
                    e.emit("resize"),
                    e.emit("fullscreenWeb", !0),
                    t.show = "") : ((0,
                    o.removeClass)(r, "art-fullscreen-web"),
                    e.aspectRatioReset = !0,
                    e.autoSize = e.option.autoSize,
                    e.emit("resize"),
    ...
    gYMLD: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {i18n: t, notice: r, template: {$video: i}} = e;
            document.pictureInPictureEnabled ? function(e) {
                const {template: {$video: t}, proxy: r, notice: i} = e;
                ...
                o.def)(e, "pip", {
                    ...
                    set(r) {
                        ...
                        e.emit("pip", !0)) : (t.webkitSetPresentationMode("inline"),
                        e.emit("pip", !1))
                    }
                })
            }(e) : (0,
                ...
                set(a) {
                    if (a) {
                        const {videoWidth: a, videoHeight: n} = i
                          ...
                          , p = s / l;
                        if ((0,
                        o.addClass)(t, "art-auto-size"),
                        p > c) {
                            const e = l * c / s * 100;
                            (0,
                            o.setStyle)(r, "width", `${e}%`),
                            (0,
                            o.setStyle)(r, "height", "100%")
                        } else {
                            const e = s / c / l * 100;
                            (0,
                            o.setStyle)(r, "width", "100%"),
                            (0,
                            o.setStyle)(r, "height", `${e}%`)
                        }
                        e.emit("autoSize", {
                            width: e.width,
                            height: e.height
                        ...
                        (0,
                        o.removeClass)(t, "art-auto-size"),
                        (0,
                        o.setStyle)(r, "width", null),
                        (0,
                        o.setStyle)(r, "height", null),
                        e.emit("autoSize")
                }
            })
        }
    ...
    dhi4g: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {template: {$player: t}, i18n: r, notice: i} = e;
            (0,
            o.def)(e, "flip", {
                ...
                set(a) {
                    ...
                    (0,
                    o.errorHandle)(n.includes(a), `'flip' only accept ${n.toString()} as parameters`),
                    "normal" === a ? delete t.dataset.flip : t.dataset.flip = a;
                    const s = a.replace(a[0], a[0].toUpperCase());
                    i.show = `${r.get("Video Flip")}: ${r.get(s)}`,
                    e.emit("flip", a)
                }
            })
        }
    ...
    eQPx9: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {i18n: t, option: r, storage: i, proxy: a, template: {$player: n, $miniClose: s, $miniTitle: l, $miniHeader: c}} = e;
            let p = !1
              , u = 0
              , d = 0
              , f = 0
            ...
            a(document, "mousemove", (e=>{
                if (p) {
                    (0,
                    o.addClass)(n, "art-is-dragging");
                    const t = h + e.pageY - d
                      , r = f + e.pageX - u;
                    (0,
                    o.setStyle)(n, "top", `${t}px`),
                    (0,
                    o.setStyle)(n, "left", `${r}px`),
                    i.set("top", t),
                    i.set("left", r)
                }
            }
            ...
            a(document, "mouseup", (()=>{
                p = !1,
                (0,
                o.removeClass)(n, "art-is-dragging")
            }
            )),
            a(s, "click", (()=>{
                e.mini = !1,
            ...
            (0,
            o.append)(l, r.title || t.get("Mini Player")),
            (0,
            o.def)(e, "mini", {
                get: ()=>(0,
                o.hasClass)(n, "art-mini"),
                set(t) {
                    if (t) {
                        e.normalSize = "mini",
                        e.autoSize = !1,
                        (0,
                        o.addClass)(n, "art-mini");
                        const t = i.get("top")
                          , r = i.get("left");
                        if (t && r)
                            (0,
                        ...
                        (0,
                        o.removeClass)(n, "art-mini"),
                        (0,
                        o.setStyle)(n, "top", null),
                        (0,
                        o.setStyle)(n, "left", null),
                        e.aspectRatio = !1,
                        e.playbackRate = !1,
                        e.autoSize = r.autoSize,
                        e.notice.show = "",
            ...
            o.def)(e, "loop", {
                ...
                set: r=>{
                    if (Array.isArray(r) && "number" == typeof r[0] && "number" == typeof r[1]) {
                        const i = (0,
                        o.clamp)(r[0], 0, Math.min(r[1], e.duration))
                          , a = (0,
                        o.clamp)(r[1], i, e.duration);
                        a - i >= 1 ? (t = [i, a],
                        e.emit("loop", t)) : (t = [],
                        e.emit("loop"))
                    } else
    ...
    "7n9Pt": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, template: {$poster: r}} = e;
            (0,
            o.def)(e, "poster", {
                get: ()=>t.poster,
                set(e) {
                    t.poster = e,
                    (0,
                    o.setStyle)(r, "backgroundImage", `url(${e})`)
                }
            })
        }
    }
    ...
    "8Az1F": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, template: {$container: r, $video: i}} = e
              , a = r.style.height;
            (0,
            o.def)(e, "autoHeight", {
                get: ()=>(0,
                o.hasClass)(r, "art-auto-height"),
                set(n) {
                    if (n) {
                        const {clientWidth: a} = r
                          ...
                          , l = n * (a / s);
                        (0,
                        o.setStyle)(r, "height", l + "px"),
                        (0,
                        o.addClass)(r, "art-auto-height"),
                        e.autoSize = t.autoSize,
                        e.emit("autoHeight", l)
                    } else
                        (0,
                        o.setStyle)(r, "height", a),
                        (0,
                        o.removeClass)(r, "art-auto-height"),
                        e.autoSize = t.autoSize,
                        e.emit("autoHeight")
                }
            })
    ...
    kXlsI: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, template: {$player: r}} = e;
            (0,
            o.def)(e, "theme", {
                get: ()=>getComputedStyle(r).getPropertyValue("--theme"),
                set(e) {
                    t.theme = e,
                    r.style.setProperty("--theme", e)
                }
            })
        }
    }
    ...
    bDxGv: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {i18n: t, notice: r, proxy: i, template: {$video: a}} = e;
            let n = !0;
            ...
            o.def)(e, "airplay", {
                value() {
                    n ? (a.webkitShowPlaybackTargetPicker(),
                    e.emit("airplay")) : r.show = t.get("AirPlay Not Available")
                }
            })
        }
    }
    ...
    luxZi: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, storage: r, template: {$video: i, $poster: a}} = e;
            ...
            t.volume && (i.volume = (0,
            o.clamp)(t.volume, 0, 1));
            const n = r.get("volume");
            "number" == typeof n && (i.volume = (0,
            o.clamp)(n, 0, 1)),
            t.poster && (0,
            o.setStyle)(a, "backgroundImage", `url(${t.poster})`),
            t.autoplay && (i.autoplay = t.autoplay),
            t.playsInline && (i.playsInline = !0,
            i["webkit-playsinline"] = !0),
    ...
    b25aJ: [function(e, t, r) {
        ...
        var i = e("../config")
          ...
          , n = e("../utils");
        r.default = function(e) {
            const {i18n: t, notice: r, option: o, constructor: i, proxy: s, template: {$player: l, $video: c, $poster: p}} = e;
            let u = 0;
            ...
            e.on("video:ended", (()=>{
                ...
                e.play(),
                e.controls.show = !1,
                e.mask.show = !1) : (e.controls.show = !0,
                e.mask.show = !0)
            }
            )),
            e.on("video:error", (async()=>{
                u < i.RECONNECT_TIME_MAX ? (await (0,
                n.sleep)(i.RECONNECT_SLEEP_TIME),
                u += 1,
                e.url = o.url,
                r.show = `${t.get("Reconnect")}: ${u}`,
                e.emit("error", u)) : (e.mask.show = !0,
                e.loading.show = !1,
                e.controls.show = !0,
                (0,
                n.addClass)(l, "art-error"),
                await (0,
                n.sleep)(i.RECONNECT_SLEEP_TIME),
    ...
    "3qXcr": [function(e, t, r) {
        ...
        class z extends n.default {
            constructor(e) {
                super(e),
                this.name = "control";
                const {proxy: t, constructor: r, template: {$player: o}} = e;
                let a = Date.now();
                t(o, ["click", "mousemove", "touchstart", "touchmove"], (()=>{
                    this.show = !0,
                    (0,
                    i.removeClass)(o, "art-hide-cursor"),
                    (0,
                    i.addClass)(o, "art-hover"),
                    a = Date.now()
                }
                )),
                e.on("video:timeupdate", (()=>{
                    !e.isInput && e.playing && this.show && Date.now() - a >= r.CONTROL_HIDE_TIME && (this.show = !1,
                    (0,
                    i.addClass)(o, "art-hide-cursor"),
                    (0,
                    i.removeClass)(o, "art-hover"))
                }
                )),
                this.init()
            }
            init() {
                ...
                !e.thumbnails.url || e.isLive || i.isMobile || this.add((0,
                S.default)({
                    name: "thumbnails",
                    position: "top",
                    index: 20
                ...
                e.quality.length && this.add((0,
                $.default)({
                    name: "quality",
                    position: "right",
                    index: 10
                })),
                e.screenshot && !i.isMobile && this.add((0,
                I.default)({
                    name: "screenshot",
                    position: "right",
                    index: 20
                })),
                e.setting && this.add((0,
                j.default)({
                    name: "setting",
                    position: "right",
                    index: 30
                ...
                e.airplay && window.WebKitPlaybackTargetAvailabilityEvent && this.add((0,
                C.default)({
                    name: "airplay",
                    position: "right",
                    index: 50
                })),
                e.fullscreenWeb && this.add((0,
                p.default)({
                    name: "fullscreenWeb",
                    position: "right",
                    index: 60
                })),
                e.fullscreen && this.add((0,
                l.default)({
                    name: "fullscreen",
                    position: "right",
                    index: 70
                }));
                for (let t = 0; t < e.controls.length; t++)
                    this.add(e.controls[t])
            }
            add(e) {
                ...
                default:
                    (0,
                    i.errorHandle)(!1, "Control option.position must one of 'top', 'left', 'right'")
                }
                super.add(t)
            }
        }
    ...
    "5MLcx": [function(e, t, r) {
        ...
        r.default = class {
            ...
            get show() {
                return (0,
                i.hasClass)(this.art.template.$player, `art-${this.name}-show`)
            }
            set show(e) {
            ...
            add(e) {
                ...
                if (t.html = t.html || "",
                (0,
                n.default)(t, s.ComponentOption),
                !this.$parent || !this.name || t.disable)
                    return;
                const r = t.name || `${this.name}${this.id}`;
                (0,
                c.errorHandle)(!(0,
                l.has)(this, r), `Cannot add an existing name [${r}] to the [${this.name}]`),
                this.id += 1;
                const o = (0,
                i.createElement)("div");
                (0,
                i.addClass)(o, `art-${this.name}`),
                (0,
                i.addClass)(o, `art-${this.name}-${r}`);
                ...
                return p ? p.insertAdjacentElement("beforebegin", o) : (0,
                i.append)(this.$parent, o),
                t.html && (0,
                i.append)(o, t.html),
                t.style && (0,
                i.setStyles)(o, t.style),
                t.tooltip && (0,
                i.tooltip)(o, t.tooltip),
                t.click && this.art.events.proxy(o, "click", (e=>{
                    e.preventDefault(),
                    t.click.call(this.art, this, e)
                }
                )),
                t.selector && ["left", "right"].includes(t.position) && this.selector(t, o),
                t.mounted && t.mounted.call(this.art, o),
                1 === o.childNodes.length && 3 === o.childNodes[0].nodeType && (0,
                i.addClass)(o, "art-control-onlyText"),
                (0,
                l.def)(this, r, {
                    value: o
                }),
            ...
            selector(e, t) {
                ...
                (0,
                i.addClass)(t, "art-control-selector");
                const a = (0,
                i.createElement)("div");
                (0,
                i.addClass)(a, "art-selector-value"),
                (0,
                i.append)(a, e.html),
                t.innerText = "",
                (0,
                ...
                i.createElement)("div");
                (0,
                i.addClass)(s, "art-selector-list"),
                (0,
                i.append)(s, n),
                (0,
                i.append)(t, s);
                const l = ()=>{
                    const e = (0,
                    i.getStyle)(t, "width") / 2 - (0,
                    i.getStyle)(s, "width") / 2;
                    s.style.left = `${e}px`
                }
                ;
                r(t, l),
                o(s, "click", (async t=>{
                    const r = (t.composedPath() || []).find((e=>(0,
                    i.hasClass)(e, "art-selector-item")));
                    if (!r)
                        return;
                    (0,
                    i.inverseClass)(r, "art-current");
                    const o = Number(r.dataset.index)
                      , n = e.selector[o] || {};
                    if (a.innerText = r.innerText,
                    e.onSelect) {
                        const o = await e.onSelect.call(this.art, n, r, t);
                        "string" != typeof o && "number" != typeof o || (a.innerHTML = o)
                    }
                    l(),
                    this.art.emit("selector", n, r)
                }
                ))
            }
        }
            ...
            return t=>({
                ...
                mounted: e=>{
                    const {proxy: r, icons: i, i18n: a} = t
                      , n = (0,
                    o.append)(e, i.fullscreenOn)
                      , s = (0,
                    o.append)(e, i.fullscreenOff);
                    (0,
                    o.setStyle)(s, "display", "none"),
                    r(e, "click", (()=>{
                    ...
                    t.on("fullscreen", (t=>{
                        t ? ((0,
                        o.tooltip)(e, a.get("Exit Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "none"),
                        (0,
                        o.setStyle)(s, "display", "inline-flex")) : ((0,
                        o.tooltip)(e, a.get("Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "inline-flex"),
                        (0,
                        o.setStyle)(s, "display", "none"))
                    }
                    ))
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    const {proxy: r, icons: i, i18n: a} = t
                      , n = (0,
                    o.append)(e, i.fullscreenWebOn)
                      , s = (0,
                    o.append)(e, i.fullscreenWebOff);
                    (0,
                    o.setStyle)(s, "display", "none"),
                    r(e, "click", (()=>{
                    ...
                    t.on("fullscreenWeb", (t=>{
                        t ? ((0,
                        o.tooltip)(e, a.get("Exit Web Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "none"),
                        (0,
                        o.setStyle)(s, "display", "inline-flex")) : ((0,
                        o.tooltip)(e, a.get("Web Fullscreen")),
                        (0,
                        o.setStyle)(n, "display", "inline-flex"),
                        (0,
                        o.setStyle)(s, "display", "none"))
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    ...
                    t.on("pip", (t=>{
                        (0,
                        o.tooltip)(e, a.get(t ? "Exit PIP Mode" : "PIP Mode"))
                    }
                    ))
                }
            })
            ...
            return t=>({
                ...
                mounted: e=>{
                    ...
                    function c() {
                        ...
                        o.setStyle)(n, "display", "none"),
                        (0,
                        o.setStyle)(s, "display", "flex")
                    }
                    (0,
                    o.tooltip)(n, a.get("Play")),
                    (0,
                    o.tooltip)(s, a.get("Pause")),
                    r(n, "click", (()=>{
                        t.play()
                    }
                    )),
        ...
        function n(e, t) {
            if (e.isRotate) {
                const r = t.touches[0].clientY / e.height
                  , o = r * e.duration;
                e.emit("setBar", "played", r),
                e.seek = o
            } else {
                const {second: r, percentage: o} = a(e, t);
                e.emit("setBar", "played", o),
                e.seek = r
            }
        }
        r.default = function(e) {
            return t=>{
                ...
                return {
                    ...
                    mounted: e=>{
                        let l = !1;
                        const c = (0,
                        i.query)(".art-progress-loaded", e)
                          , p = (0,
                        i.query)(".art-progress-played", e)
                          , u = (0,
                        i.query)(".art-progress-highlight", e)
                          , d = (0,
                        i.query)(".art-progress-indicator", e)
                          , f = (0,
                        i.query)(".art-progress-tip", e);
                        (0,
                        i.setStyle)(p, "backgroundColor", "var(--theme)");
                        let h = t.constructor.INDICATOR_SIZE;
                        function m(e, t) {
                            "loaded" === e && (0,
                            i.setStyle)(c, "width", 100 * t + "%"),
                            "played" === e && ((0,
                            i.setStyle)(p, "width", 100 * t + "%"),
                            (0,
                            i.setStyle)(d, "left", `calc(${100 * t}% - ${h / 2}px)`))
                        }
                        r.indicator ? (h = t.constructor.INDICATOR_SIZE_ICON,
                        (0,
                        i.append)(d, r.indicator)) : (0,
                        i.setStyles)(d, {
                            backgroundColor: "var(--theme)"
                        }),
                        i.isMobile && (h = t.constructor.INDICATOR_SIZE_MOBILE,
                        ...
                        t.on("video:loadedmetadata", (()=>{
                            for (let e = 0; e < o.highlight.length; e++) {
                                const r = o.highlight[e]
                                  , a = (0,
                                i.clamp)(r.time, 0, t.duration) / t.duration * 100;
                                (0,
                                i.append)(u, `<span data-text="${r.text}" data-time="${r.time}" style="left: ${a}%"></span>`)
                            }
                        }
                        )),
                        m("loaded", t.loaded),
                        ...
                        s(e, "mousemove", (r=>{
                            (0,
                            i.setStyle)(f, "display", "block"),
                            (0,
                            i.includeFromEvent)(r, u) ? function(r) {
                                const {width: o} = a(t, r)
                                  , {text: n} = r.target.dataset;
                                f.innerHTML = n;
                                const s = f.clientWidth;
                                o <= s / 2 ? (0,
                                i.setStyle)(f, "left", 0) : o > e.clientWidth - s / 2 ? (0,
                                i.setStyle)(f, "left", e.clientWidth - s + "px") : (0,
                                i.setStyle)(f, "left", o - s / 2 + "px")
                            }(r) : function(r) {
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    function r() {
                        const r = `${(0,
                        o.secondToTime)(t.currentTime)} / ${(0,
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    ...
                    o.append)(e, i.volume)
                      , p = (0,
                    o.append)(e, i.volumeClose)
                      , u = (0,
                    o.append)(e, '<div class="art-volume-panel"></div>')
                      , d = (0,
                    o.append)(u, '<div class="art-volume-slider-handle"></div>');
                    function f(e) {
                        const {left: t} = u.getBoundingClientRect();
                        return (0,
                        o.clamp)(e.pageX - t - l / 2, 0, s - l / 2) / (s - l)
                    }
                    function h(e=.7) {
                        if (t.muted || 0 === e)
                            (0,
                            ...
                            (0,
                            o.setStyle)(p, "display", "none"),
                            (0,
                            o.setStyle)(d, "left", `${t}px`)
                        }
                    }
                    (0,
                    o.tooltip)(c, a.get("Mute")),
                    (0,
                    o.setStyle)(p, "display", "none"),
                    o.isMobile && (0,
                    o.setStyle)(u, "display", "none"),
                    h(t.volume),
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    ...
                    t.on("setting", (t=>{
                        (0,
                        o.tooltip)(e, a.get(t ? "Hide Setting" : "Show Setting"))
                    }
                    ))
                }
            })
    ...
    lTgvI: [function(e, t, r) {
        ...
        r.default = function(e) {
            return t=>({
                ...e,
                mounted: e=>{
                    const {option: r, template: {$progress: a, $video: n}, events: {proxy: s, loadImg: l}} = t;
                    let c = null
                      , p = !1
                      , u = !1;
                    s(a, "mousemove", (async s=>{
                        ...
                        u && ((0,
                        o.setStyle)(e, "display", "block"),
                        function(s) {
                            const {width: l} = (0,
                            i.getPosFromEvent)(t, s)
                              ...
                              , x = v % d || d - 1;
                            (0,
                            o.setStyle)(e, "backgroundImage", `url(${p})`),
                            (0,
                            o.setStyle)(e, "height", `${g}px`),
                            (0,
                            o.setStyle)(e, "width", `${m}px`),
                            (0,
                            o.setStyle)(e, "backgroundPosition", `-${x * m}px -${b * g}px`),
                            l <= m / 2 ? (0,
                            o.setStyle)(e, "left", 0) : l > a.clientWidth - m / 2 ? (0,
                            o.setStyle)(e, "left", a.clientWidth - m + "px") : (0,
                            o.setStyle)(e, "left", l - m / 2 + "px")
                        }(s))
                    }
                    )),
                    s(a, "mouseout", (()=>{
                        (0,
                        o.setStyle)(e, "display", "none")
                    }
                    ))
                }
            })
    ...
    d1O2Q: [function(e, t, r) {
        ...
        r.default = function(e) {
            return t=>({
                ...
                mounted: e=>{
                    const r = (0,
                    o.append)(e, '<span class="art-loop-point"></span>')
                      , i = (0,
                    o.append)(e, '<span class="art-loop-point"></span>');
                    t.on("loop", (a=>{
                        a ? ((0,
                        o.setStyle)(e, "display", "block"),
                        (0,
                        o.setStyle)(r, "left", `calc(${a[0] / t.duration * 100}% - ${r.clientWidth}px)`),
                        (0,
                        o.setStyle)(i, "left", a[1] / t.duration * 100 + "%")) : (0,
                        o.setStyle)(e, "display", "none")
                    }
                    ))
                }
    ...
    hTnNz: [function(e, t, r) {
        ...
        class b extends n.default {
            ...
            init() {
                const {option: e, proxy: t, template: {$player: r, $contextmenu: o}} = this.art;
                e.playbackRate && this.add((0,
                l.default)({
                    name: "playbackRate",
                    index: 10
                })),
                e.aspectRatio && this.add((0,
                p.default)({
                    name: "aspectRatio",
                    index: 20
                })),
                ...
                t(r, "click", (e=>{
                    (0,
                    i.includeFromEvent)(e, o) || (this.show = !1)
                }
                )),
                this.art.on("blur", (()=>{
                    this.show = !1
    ...
    "1uTBJ": [function(e, t, r) {
        ...
        r.default = function(e) {
            return t=>{
                ...
                return {
                    ...e,
                    html: `${r.get("Play Speed")}:<span data-value="0.5">0.5</span><span data-value="0.75">0.75</span><span data-value="1.0" class="art-current">${r.get("Normal")}</span><span data-value="1.25">1.25</span><span data-value="1.5">1.5</span><span data-value="2.0">2.0</span>`,
                    click: (e,r)=>{
                        const {value: o} = r.target.dataset;
                        o && (t.playbackRate = Number(o),
                        e.show = !1)
                    }
                    ,
                    mounted: e=>{
                        t.on("playbackRate", (t=>{
                            const r = (0,
                            o.queryAll)("span", e).find((e=>Number(e.dataset.value) === t));
                            r && (0,
    ...
    cFKj0: [function(e, t, r) {
        ...
        r.default = function(e) {
            return t=>{
                ...
                return {
                    ...e,
                    html: `${r.get("Aspect Ratio")}:<span data-value="default" class="art-current">${r.get("Default")}</span><span data-value="4:3">4:3</span><span data-value="16:9">16:9</span>`,
                    click: (e,r)=>{
                        const {value: o} = r.target.dataset;
                        o && (t.aspectRatio = o,
                        e.show = !1)
                    ...
                    mounted: e=>{
                        t.on("aspectRatio", (t=>{
                            const r = (0,
                            o.queryAll)("span", e).find((e=>e.dataset.value === t));
                            r && (0,
                            o.inverseClass)(r, "art-current")
                        }
                        ))
    ...
    l7S3g: [function(e, t, r) {
        ...
        r.default = function(e) {
            return t=>{
                ...
                return {
                    ...e,
                    html: `${r.get("Video Flip")}:<span data-value="normal" class="art-current">${r.get("Normal")}</span><span data-value="horizontal">${r.get("Horizontal")}</span><span data-value="vertical">${r.get("Vertical")}</span>`,
                    click: (e,r)=>{
                        const {value: o} = r.target.dataset;
                        o && (t.flip = o,
                        e.show = !1)
    ...
    bfwuE: [function(e, t, r) {
        ...
        class s extends n.default {
            ...
            init() {
                const {proxy: e, constructor: t, template: {$infoPanel: r, $infoClose: o, $video: a}} = this.art;
                e(o, "click", (()=>{
                    this.show = !1
                }
                ));
    ...
    bWZ2U: [function(e, t, r) {
        ...
        class u extends n.default {
            ...
            update() {
                ...
                e.innerHTML = "",
                this.activeCue && (e.innerHTML = this.activeCue.text.split(/\r?\n/).map((e=>`<p>${(0,
                i.escape)(e)}</p>`)).join(""),
            ...
            async switch(e, t={}) {
                const {i18n: r, notice: o, option: i} = this.art
                  ...
                  , n = await this.init(a);
                return t.name && (o.show = `${r.get("Switch Subtitle")}: ${t.name}`),
                n
            }
            createTrack(e, t) {
            ...
            async init(e) {
                const {notice: t, template: {$subtitle: r}} = this.art;
                if ((0,
                l.default)(e, p.default.subtitle),
                e.url)
                    return this.style(e.style),
                    fetch(e.url).then((e=>e.arrayBuffer())).then((t=>{
                        const r = new TextDecoder(e.encoding).decode(t);
                        switch (this.art.emit("subtitleLoad", e.url),
                        e.type || (0,
                        i.getExt)(e.url)) {
                        case "srt":
                            return (0,
                    ...
                    this.url === e || (URL.revokeObjectURL(this.url),
    ...
    "9oLaG": [function(e, t, r) {
        ...
        r.default = class {
            ...
            proxy(e, t, r, o={}) {
                if (Array.isArray(t))
                    return t.map((t=>this.proxy(e, t, r, o)));
                e.addEventListener(t, r, o);
                const i = ()=>e.removeEventListener(t, r, o);
                return this.destroyEvents.push(i),
                i
            }
            hover(e, t, r) {
            ...
            loadImg(e) {
                return new Promise(((t,r)=>{
                    ...
                    if (e instanceof HTMLImageElement)
                        ...
                        if ("string" != typeof e)
                            return r(new (0,
                            i.ArtPlayerError)("Unable to get Image"));
                        o = new Image,
                        o.src = e
                    }
                    if (o.complete)
                    ...
                    this.proxy(o, "error", (()=>r(new (0,
                    i.ArtPlayerError)(`Failed to load Image: ${o.src}`))))
                }
                ))
            }
            destroy() {
    ...
    hrnqi: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e, t) {
            const {constructor: r, template: {$player: i, $video: a}} = e;
            t.proxy(document, ["click", "contextmenu"], (t=>{
                (0,
                o.includeFromEvent)(t, i) ? (e.isInput = "INPUT" === t.target.tagName,
                e.isFocus = !0,
                e.emit("focus")) : (e.isInput = !1,
                e.isFocus = !1,
                e.emit("blur"))
            }
            ));
            ...
            t.proxy(a, "click", (()=>{
                const t = Date.now();
                t - n <= r.DB_CLICE_TIME ? (e.emit("dblclick"),
                o.isMobile ? e.isLock || e.toggle() : e.fullscreen = !e.fullscreen) : (e.emit("click"),
                o.isMobile || e.toggle()),
                n = t
            }
            ))
                  ...
                  , d = t=>{
                    if (1 === t.touches.length && s && e.duration) {
                        const {clientX: i, clientY: a} = t.touches[0]
                          , s = (0,
                        o.clamp)((i - l) / e.width, -1, 1)
                          , u = (0,
                        o.clamp)((a - c) / e.height, -1, 1)
                          , d = e.isRotate ? u : s
                          , f = n === r ? e.constructor.TOUCH_MOVE_RATIO : 1
                          , h = (0,
                        o.clamp)(p + e.duration * d * f, 0, e.duration);
                        e.seek = h,
                        e.emit("setBar", "played", (0,
                        o.clamp)(h / e.duration, 0, 1)),
                        e.notice.show = `${(0,
                        o.secondToTime)(h)} / ${(0,
                        o.secondToTime)(e.duration)}`
                    }
    ...
    cJlT5: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e, t) {
            const {option: r, constructor: i, template: {$container: a}} = e
              , n = (0,
            o.throttle)((()=>{
                e.emit("view", (0,
                o.isInViewport)(a, i.SCROLL_GAP))
            }
            ), i.SCROLL_TIME);
    ...
    cKO4X: [function(e, t, r) {
        ...
        r.default = class {
            ...
            add(e, t) {
                return this.keys[e] ? this.keys[e].push(t) : this.keys[e] = [t],
                this
            }
            remove(e, t) {
                if (this.keys[e]) {
    ...
    kZD92: [function(e, t, r) {
        ...
        class n extends a.default {
            constructor(e) {
                super(e);
                const {option: t, template: {$layer: r}} = e;
                this.name = "layer",
                this.$parent = r;
    ...
    c9b9e: [function(e, t, r) {
        ...
        class s extends n.default {
            constructor(e) {
                ...
                this.name = "loading",
                (0,
                i.append)(e.template.$loading, e.icons.loading)
            }
        }
        r.default = s
    }
    ...
    SxQeL: [function(e, t, r) {
        ...
        r.default = class {
            ...
            set show(e) {
                const {constructor: t, template: {$player: r, $noticeInner: i}} = this.art;
                e ? (i.innerText = e instanceof Error ? e.message.trim() : e,
                (0,
                o.addClass)(r, "art-notice-show"),
                clearTimeout(this.timer),
                this.timer = setTimeout((()=>{
                    i.innerText = "",
                    (0,
                    o.removeClass)(r, "art-notice-show")
                }
                ), t.NOTICE_TIME)) : (0,
                o.removeClass)(r, "art-notice-show")
            }
        ...
        class s extends n.default {
            constructor(e) {
                ...
                const {template: t, icons: r, events: o} = e
                  , a = (0,
                i.append)(t.$state, r.state)
                  , n = (0,
                i.append)(t.$state, r.error);
                (0,
                i.setStyle)(n, "display", "none"),
                e.on("destroy", (()=>{
                    (0,
                    i.setStyle)(a, "display", "none"),
                    (0,
                    i.setStyle)(n, "display", null)
                }
                )),
                ...
                Object.keys(t).forEach((e=>{
                    ...
                    i.def)(this, e, {
                        get: ()=>{
                            ...
                            i.createElement)("i");
                            return (0,
                            i.addClass)(r, "art-icon"),
                            (0,
                            i.addClass)(r, `art-icon-${e}`),
                            (0,
                            i.append)(r, t[e]),
                            r
                        }
    ...
    hdF39: [function(e, t, r) {
        ...
        class y extends f.default {
            constructor(e) {
                super(e);
                const {option: t, proxy: r, template: {$setting: o, $player: i}} = e;
                if (this.name = "setting",
                this.$parent = o,
                this.option = [],
                this.events = [],
                this.cache = new Map,
                t.setting) {
                    t.playbackRate && this.option.push((0,
                    c.default)(e)),
                    t.aspectRatio && this.option.push((0,
                    s.default)(e)),
                    t.flip && this.option.push((0,
                    a.default)(e)),
                    t.subtitleOffset && this.option.push((0,
                    u.default)(e));
                    for (let e = 0; e < t.settings.length; e++)
                        this.option.push(t.settings[e]);
                    ...
                    r(i, "click", (t=>{
                        !this.show || (0,
                        h.includeFromEvent)(t, e.controls.setting) || (0,
                        h.includeFromEvent)(t, this.$parent) || (this.show = !1,
                        this.init(this.option))
                    }
                    ))
                }
            ...
            creatHeader(e) {
                ...
                h.createElement)("div");
                (0,
                h.addClass)(o, "art-setting-item"),
                (0,
                h.addClass)(o, "art-setting-item-back");
                const i = (0,
                h.append)(o, '<div class="art-setting-item-left"></div>')
                  , a = (0,
                h.createElement)("div");
                (0,
                h.addClass)(a, "art-setting-item-left-icon"),
                (0,
                h.append)(a, t.arrowLeft),
                (0,
                h.append)(i, a),
                (0,
                h.append)(i, e.$parentItem.html);
                const n = r(o, "click", (()=>{
            ...
            creatItem(e, t) {
                ...
                h.createElement)("div");
                (0,
                h.addClass)(i, "art-setting-item"),
                g(t.name) && (i.dataset.name = t.name),
                g(t.value) && (i.dataset.value = t.value);
                const a = (0,
                h.append)(i, '<div class="art-setting-item-left"></div>')
                  , n = (0,
                h.append)(i, '<div class="art-setting-item-right"></div>')
                  , s = (0,
                h.createElement)("div");
                switch ((0,
                h.addClass)(s, "art-setting-item-left-icon"),
                e) {
                case "switch":
                case "range":
                    (0,
                    h.append)(s, g(t.icon) || t.icon instanceof Element ? t.icon : r.config);
                    break;
                case "selector":
                    t.selector && t.selector.length ? (0,
                    h.append)(s, g(t.icon) || t.icon instanceof Element ? t.icon : r.config) : (0,
                    h.append)(s, r.check)
                }
                (0,
                h.append)(a, s),
                ...
                h.createElement)("div");
                (0,
                h.addClass)(l, "art-setting-item-left-text"),
                (0,
                h.append)(l, t.html || ""),
                (0,
                h.append)(a, l),
                ...
                h.createElement)("div");
                switch ((0,
                h.addClass)(c, "art-setting-item-right-tooltip"),
                (0,
                h.append)(c, t.tooltip || ""),
                (0,
                h.append)(n, c),
                t.$tooltip = c,
                (0,
                ...
                case "switch":
                    {
                        ...
                        h.createElement)("div");
                        (0,
                        h.addClass)(e, "art-setting-item-right-icon");
                        const o = (0,
                        h.append)(e, r.switchOn)
                          , i = (0,
                        h.append)(e, r.switchOff);
                        (0,
                        h.setStyle)(t.switch ? i : o, "display", "none"),
                        (0,
                        h.append)(n, e),
                        t.$switch = t.switch,
                        (0,
                        h.def)(t, "switch", {
                            ...
                            set(e) {
                                t.$switch = e,
                                e ? ((0,
                                h.setStyle)(i, "display", "none"),
                                (0,
                                h.setStyle)(o, "display", null)) : ((0,
                                h.setStyle)(i, "display", null),
                                (0,
                ...
                case "range":
                    {
                        ...
                        h.addClass)(e, "art-setting-item-right-icon");
                        const r = (0,
                        h.append)(e, '<input type="range">');
                        r.value = t.range[0] || 0,
                        r.min = t.range[1] || 0,
                        r.max = t.range[2] || 10,
                        r.step = t.range[3] || 1,
                        (0,
                        h.addClass)(r, "art-setting-range"),
                        (0,
                        h.append)(n, e),
                        t.$range = r,
                        (0,
                ...
                case "selector":
                    {
                        const e = o(i, "click", (async e=>{
                            if (t.selector && t.selector.length)
                                this.init(t.selector, t.width);
                            else if ((0,
                            h.inverseClass)(i, "art-current"),
            ...
            init(e, t) {
                ...
                if (this.cache.has(e)) {
                    ...
                    (0,
                    h.inverseClass)(t, "art-current"),
                    (0,
                    h.setStyle)(this.$parent, "width", `${t.dataset.width}px`),
                    (0,
                    h.setStyle)(this.$parent, "height", `${t.dataset.height}px`)
                } else {
                    const o = (0,
                    h.createElement)("div");
                    (0,
                    h.addClass)(o, "art-setting-panel"),
                    o.dataset.width = t || r.SETTING_WIDTH,
                    o.dataset.height = e.length * r.SETTING_ITEM_HEIGHT,
                    e[0] && e[0].$parentItem && ((0,
                    h.append)(o, this.creatHeader(e[0])),
                    o.dataset.height = Number(o.dataset.height) + r.SETTING_ITEM_HEIGHT);
                    for (let t = 0; t < e.length; t++) {
                        const r = e[t];
                        (0,
                        h.has)(r, "switch") ? (0,
                        h.append)(o, this.creatItem("switch", r)) : (0,
                        h.has)(r, "range") ? (0,
                        h.append)(o, this.creatItem("range", r)) : (0,
                        h.append)(o, this.creatItem("selector", r))
                    }
                    (0,
                    h.append)(this.$parent, o),
                    this.cache.set(e, o),
                    (0,
                    h.inverseClass)(o, "art-current"),
                    (0,
                    h.setStyle)(this.$parent, "width", `${o.dataset.width}px`),
                    (0,
                    h.setStyle)(this.$parent, "height", `${o.dataset.height}px`),
                    e[0] && e[0].$parentItem && e[0].$parentItem.mounted && e[0].$parentItem.mounted.call(this.art, o, e[0].$parentItem)
                }
            }
        }
        r.default = y
    ...
    eyzeE: [function(e, t, r) {
        ...
        r.default = function(e) {
            ...
            function n(e, r, i) {
                ...
                const n = (0,
                o.queryAll)(".art-setting-item", e).find((e=>e.dataset.value === i));
                n && (0,
                o.inverseClass)(n, "art-current")
            }
            return {
    ...
    jTfLi: [function(e, t, r) {
        ...
        r.default = function(e) {
            ...
            function n(e, t, r) {
                t && (t.innerText = a(r));
                const i = (0,
                o.queryAll)(".art-setting-item", e).find((e=>e.dataset.value === r));
                i && (0,
                o.inverseClass)(i, "art-current")
            }
            return {
                width: i.SETTING_ITEM_WIDTH,
    ...
    aowja: [function(e, t, r) {
        ...
        r.default = function(e) {
            ...
            function n(e, t, r) {
                t && (t.innerText = a(r));
                const i = (0,
                o.queryAll)(".art-setting-item", e).find((e=>Number(e.dataset.value) === r));
                i && (0,
                o.inverseClass)(i, "art-current")
            }
            return {
                ...
                icon: r.playbackRate,
                selector: [.5, .75, 1, 1.25, 1.5, 2].map((t=>({
                    value: t,
    ...
    "1v13t": [function(e, t, r) {
        ...
        r.default = class {
            ...
            add(e) {
                ...
                return (0,
                i.errorHandle)(!(0,
                i.has)(this, r), `Cannot add a plugin that already has the same name: ${r}`),
                (0,
                i.def)(this, r, {
                    value: t
                }),
    ...
    bcdCk: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {option: t, constructor: r, template: {$player: i, $video: a}} = e;
            return e.on("fullscreenWeb", (n=>{
                if (n) {
                    ...
                    (t > n && s < l || t < n && s > l) && setTimeout((()=>{
                        (0,
                        o.setStyle)(i, "width", `${l}px`),
                        (0,
                        o.setStyle)(i, "height", `${s}px`),
                        (0,
                        o.setStyle)(i, "transform-origin", "0 0"),
                        (0,
                        o.setStyle)(i, "transform", `rotate(90deg) translate(0, -${s}px)`),
                        (0,
                        o.addClass)(i, "art-auto-orientation"),
                        e.isRotate = !0,
                        e.emit("resize")
                    }
                    ...
                    (0,
                    o.hasClass)(i, "art-auto-orientation") && ((0,
                    o.setStyle)(i, "width", null),
                    (0,
                    o.setStyle)(i, "height", null),
                    (0,
                    o.setStyle)(i, "transform", null),
                    (0,
                    o.setStyle)(i, "transform-origin", null),
                    (0,
                    o.removeClass)(i, "art-auto-orientation"),
                    e.isRotate = !1,
                    e.aspectRatioReset = !0,
                    e.autoSize = t.autoSize,
                    e.notice.show = "",
            ...
            e.on("fullscreen", (async e=>{
                ...
                if (e) {
                    ...
                    if (e > r && n < s || e < r && n > s) {
                        ...
                        (0,
                        o.addClass)(i, "art-auto-orientation-fullscreen")
                    }
                } else
                    (0,
                    o.hasClass)(i, "art-auto-orientation-fullscreen") && (await screen.orientation.lock(t),
                    (0,
                    o.removeClass)(i, "art-auto-orientation-fullscreen"))
            }
            )),
            {
                ...
                get state() {
                    return (0,
                    o.hasClass)(i, "art-auto-orientation")
                }
            }
        }
    }
    ...
    "1nHHC": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {i18n: t, icons: r, storage: i, constructor: a, proxy: n, template: {$poster: s}} = e
              , l = e.layers.add({
                name: "autoPlayback",
                html: '<div class="art-autoPlayback-close"></div><div class="art-autoPlayback-last"></div><div class="art-autoPlayback-jump"></div>'
            })
              , c = (0,
            o.query)(".art-autoPlayback-last", l)
              , p = (0,
            o.query)(".art-autoPlayback-jump", l)
              , u = (0,
            o.query)(".art-autoPlayback-close", l);
            ...
            e.on("ready", (()=>{
                ...
                d && d >= a.AUTO_PLAYBACK_MIN && ((0,
                o.append)(u, r.close),
                (0,
                o.setStyle)(l, "display", "flex"),
                c.innerText = `${t.get("Last Seen")} ${(0,
                o.secondToTime)(d)}`,
                p.innerText = t.get("Jump Play"),
                n(u, "click", (()=>{
                    (0,
                    o.setStyle)(l, "display", "none")
                }
                )),
                n(p, "click", (()=>{
                    e.seek = d,
    ...
    "4gkmX": [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {constructor: t, proxy: r, template: {$player: i, $video: a}} = e;
            let n = null
              , s = !1;
            const l = ()=>{
                clearTimeout(n),
                ...
                e.playbackRate = 1,
                (0,
                o.removeClass)(i, "art-fast-forward"))
            }
            ;
    ...
    ij5nM: [function(e, t, r) {
        e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
        var o = e("../utils");
        r.default = function(e) {
            const {layers: t, icons: r, template: {$player: i}} = e;
            return t.add({
                name: "lock",
                mounted(t) {
                    const i = (0,
                    ...
                    e.on("lock", (e=>{
                        e ? ((0,
                        o.setStyle)(i, "display", "inline-flex"),
                        (0,
                        o.setStyle)(a, "display", "none")) : ((0,
                        o.setStyle)(i, "display", "none"),
                        (0,
                        o.setStyle)(a, "display", "inline-flex"))
                    }
                    ))
                },
                click() {
                    (0,
                    o.hasClass)(i, "art-lock") ? ((0,
                    o.removeClass)(i, "art-lock"),
                    this.isLock = !1,
                    e.emit("lock", !1)) : ((0,
                    o.addClass)(i, "art-lock"),
                    this.isLock = !0,
                    e.emit("lock", !0))
                }
            }),
    ...
    eD5Ch: [function(e, t, r) {
        ...
        r.default = class {
            constructor(e) {
                const {option: t, proxy: r, template: {$video: o}} = e;
                for (let t = 0; t < a.default.events.length; t++)
                ...
                t.volume && (o.volume = (0,
                n.clamp)(t.volume, 0, 1)),
                t.poster && (o.poster = t.poster),
                t.autoplay && (o.autoplay = t.autoplay),
                t.playsInline && (o.playsInline = !0,
                o["webkit-playsinline"] = !0);
                const i = t.type || (0,
                n.getExt)(t.url)
                  , s = t.customType[i];
                i && s ? (s(o, t.url, e),
                e.emit("customType", i)) : (o.src = t.url,
                e.emit("url", o.src))
            }
        }
    }
